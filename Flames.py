...
if __name__ == "__main__" :
	...
	root.title("Flames by Jayanth")
	label1 = Label(root, text = "Your Name: " ,
				fg = 'black', bg = 'cyan')
	label2 = Label(root, text = "Other Name: ",
				fg = 'black', bg = 'cyan')
	label3 = Label(root, text = "Relationship Status: ",
				fg = 'black', bg = 'olivedrab1')
	label1.grid(row = 1, column = 1, sticky ="E")
	label2.grid(row = 3, column = 1, sticky ="E")
	label3.grid(row = 7, column = 1, sticky ="E")
	Player1_field = Entry(root)
	Player2_field = Entry(root)
	Status_field = Entry(root)
	Player1_field.grid(row = 2, column = 2, ipadx ="50")
	Player2_field.grid(row = 4, column = 2, ipadx ="50")
	Status_field.grid(row = 9, column = 2, ipadx ="50")
	button1 = Button(root, text = "Submit", bg = "lawn green",
					fg = "black", command = tell_status)
	button2 = Button(root, text = "Clear", bg = "lawn green",
